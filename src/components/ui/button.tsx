  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        quiz: "border-2 border-muted bg-card text-foreground hover:border-primary hover:bg-muted/50 hover:scale-[1.02] active:scale-[0.98] text-left justify-start px-6 py-4 h-auto min-h-[60px]",
        quizCorrect: "border-2 border-success bg-success/20 text-foreground scale-[1.02]",
        quizWrong: "border-2 border-accent bg-accent/20 text-foreground animate-shake",
        quizSelected: "border-2 border-primary bg-primary/20 text-foreground",
      },
      size: {
